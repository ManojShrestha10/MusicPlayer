...
//Creating an array to stores all the songs
const allSongs = [
  {
    id: 0,
    title: "Yatra",
    artist: "Vten",
    duration: "6:21",
    src: "https://youtu.be/7RN8gYxHW54?si=fabMVYXS57M_HpJt",
  },
  {
    id: 1,
...
//object to keep track of the songs
let userData = {
  songs: [...allSongs], //spread operator to copy songs from the allSongs array
  currentSong: null,
  songCurrentTime: 0,
};
